...
class Transformer(nn.Module):
    def __init__(self, src_vocab_size, trg_vocab_size, args):
        super().__init__()
        ...
        self.src_positional_encoder = PositionalEncoder(args.src_seq_len, args)
        self.trg_positional_encoder = PositionalEncoder(args.trg_seq_len, args)
...
class PositionalEncoder(nn.Module):
    def __init__(self, seq_len, args):
        ...
        self.positional_encoding = pe_matrix.to(args.rank).requires_grad_(False)
